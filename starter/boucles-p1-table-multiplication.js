...
if (valeur && table) {
    ...
    console.log("Veillez mettre un nombre")
}
...
let valeur = parseInt(prompt("Combien de valeurs souhaitez-vous afficher pour cette table ?"));
console.log(valeur);

if (table) {
    for (let i = 1; i <= 10; i++)
        console.log(`${table} * ${valeur} = ${table * valeur}`)
} else {
